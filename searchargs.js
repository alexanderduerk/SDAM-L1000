...
function translateToSQL(searchArg, table) {
  ...
  if (table === 'signature_infos') {
    header = `SELECT si.sig_id,
                     ...
                     si.median_recall_rank_wtcs_50,
                     si.median_recall_score_spearman,
                     si.median_recall_score_wtcs_50,
                     si.batch_effect_tstat,
                     si.batch_effect_tstat_pct,
                     si.is_hiq,
                     si.qc_pass,
                     si.det_wells,
                     si.det_plates,
